...
const socialIcons: SocialIconConfig[] = [
    { icon: 'mdi:instagram', href: 'https://instagram.com/votre-profil', name: "instagram" },
    { icon: 'mingcute:linkedin-line', href: 'https://linkedin.com/in/votre-profil', name: "linkedin" },
    { icon: 'icon-park-outline:dribble', href: 'https://dribbble.com/votre-profil', name: "dribbble" },
    { icon: 'ri:behance-line', href: 'https://behance.net/votre-profil', name: "behance" },
];
