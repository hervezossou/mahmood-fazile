...
export const Button = ({ label, variant, onClick }: ButtonProps) => {
  const baseStyle =
    "w-max h-[33px] lg:h-[43px] flex items-center justify-center px-5 py-2 rounded-md lg:px-10 lg:py-3 gap-2.5 font-medium lg:font-bold font-display text-sm lg:text-base cursor-pointer";
